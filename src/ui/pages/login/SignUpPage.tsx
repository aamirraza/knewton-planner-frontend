...
import { Level, LevelItem, Pagination } from '@patternfly/react-core';
import {
  TextInput,
  Text,
  Chip,
...
import { loginOperations } from 'store/auth';
...
export interface DispatchProps {
  clearCredentials: typeof loginOperations.clearCredentials;
}

const mapDispatchToProps: DispatchProps = {
  clearCredentials: loginOperations.clearCredentials,
};
...
export class SignUpPage extends React.Component<Props, State> {
  ...
  addData(data: LoginState): void {
    this.props.clearCredentials({ ...data});
  }
  ...
  handlePasswordChange = (passwordValue: any) => {
    this.setState({ passwordValue });
    console.log(this.state.passwordValue);
  };

  onRememberMeClick = (value: any) => {
    this.setState({ isRememberMeChecked: !this.state.isRememberMeChecked });
    console.log(this.state.isRememberMeChecked);
  };
  ...
  render() {
    const loginForm = (
      <LoginForm
        ...
        usernameValue={this.props.loginState?.usernameValue}
